                ...
                <div class="mbr-navbar__column mbr-navbar__menu">
                    <nav class="mbr-navbar__menu-box mbr-navbar__menu-box--inline-right">
                        <div class="mbr-navbar__column"> 
                          <ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-decorator mbr-buttons--active"><li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-primary" href="index.php">HOME</a></li><li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-primary" href="elibrary.php">E-LIBRARY</a></li> <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-primary" href="mathscore.php">MATHS RESULTS</a></li> <li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-primary" href="engscore.php">ENGLISH RESULTS</a></li><li class="mbr-navbar__item"><a class="mbr-buttons__link btn text-primary" href="logout.php">LOGOUT</a></li></ul></div>
                    </nav>
                </div>
            </div>
        </div>
...
<section class="mbr-section" id="header3-3">
    <div class="mbr-section__container container mbr-section__container--first">
						...
						<h4 class="title text-center"><marquee>dddd</marquee></h4>
...
<form action="/users/1" method="post" accept-charset"utf-8"><fieldset id="your_information"><legend>Your Information</legend><ol>
<li><label for="name">Your Name</label><input type="text" name="name" value="" id="name"></li>
<li><label for="city">City</label><input type="text" name="city" value="" id="city"></li>
<li><label for="state">State</label><input type="text" name="state" value="" id="state"></li>
<li><label for="postal_code">Postal Code</label><input type="text" name="postal_code" value="" id="postal_code"></li>
<li><label for="email">Email</label><input type="text" name="email" value="" id="email"></li></ol></fieldset>
...
if ($n>0)
{		
echo "You have submitted week $weeks task. Click here <a href='engscore.php'><b>here</a></b> for your unofficial result.";
}
else
{
...

{
	...
	echo "<p align='center'><b>Oops! No Test for this week. Kindly attempt another week or Log out. Thanks.</b></p>";
