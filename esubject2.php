...
<?php
echo  "<p align='center'><b>You have attempted this week's task. Kindly select another week's task or Log out. Thanks.</b></p><form id='form2' name='form2' method='post' action='base.php' p align='center'>
        ...
        <div align='center'>Subject <select name='subject'>
         ...
         <input name='class' type='hidden' id='class' value='$class' />
                  ...
                  <label>
                     <div align='center'>
                     <input type='hidden' name='pincode' value='$pincode'/></div><div align='center'><input type='hidden' name='number' value='1'/></div>
                   </label>
               <p align='center'>
                   <label></label>
