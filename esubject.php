...
<?php
echo  "<form id='form' name='form2' method='post' action='base.php' p align='center'>
        ...
        SUBJECTS<br/> <select name='subject' id='lname'>
         ...
         <input name='class' type='hidden'  value='$class' id='lname'/>
        
        </label></td><td align='center'> <label><p align='center'>
                   <label></label>
                   
                   <button style='font-size: 10pt; font-family: arial; font-weight: bold; color: #ffffff; background-color : #0000ff; border-color: #bbbbff; width: 20'>NEXT STEP</button></form></p> </label></td></tr></table>
