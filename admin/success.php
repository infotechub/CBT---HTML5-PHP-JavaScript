...
<!--recommended_items-->
						<h4 class="title text-center"><marquee><img alt="" src="images/dogrunning.gif"> Welcome to the Web browser version of Jozi Computer-Based Test Platform. We also have desktop version and smart phones versions of this interactive application.</marquee></h4>
...
$sql1="INSERT INTO answers(answer1, answer2, answer3, answer4, answer5, answer6, answer7, answer8, answer9, answer10, weeks, class, pincode, section, subject) VALUES ('$answer1', '$answer2', '$answer3', '$answer4', '$answer5', '$answer6', '$answer7', '$answer8', '$answer9', '$answer10','$weeks', '$class', '$pincode', '$section', '$subject')";
if (mysql_query($sql1))
{
...
function cd() {
 	...
 	secs = 0 + s(":10"); // change seconds here (always add an additional second to your total)
 	redo();
}
