...
$sql9="SELECT * FROM mathanswers WHERE pincode='$pincode' && weeks='$weeks'";
...
{
$sql1="INSERT INTO mathanswers(answer1, answer2, answer3, answer4, answer5, answer6, answer7, answer8, answer9, answer10, weeks, class, pincode) VALUES ('$answer1', '$answer2', '$answer3', '$answer4', '$answer5', '$answer6', '$answer7', '$answer8', '$answer9', '$answer10','$weeks', '$class', '$pincode')";
if (mysql_query($sql1))
{
header ("Location: myperformance2.php");
exit (); 
}
}
