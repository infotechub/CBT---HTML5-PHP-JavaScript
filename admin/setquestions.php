...
//else
/*{
$sql9="SELECT * FROM questions WHERE weeks='$weeks' && section='$section' && subject='$subject' && class='$class'";
...
@$subject=$_COOKIE['subject'];
@$section=$_COOKIE['section'];
$sql="SELECT * FROM questions WHERE weeks = '$weeks' && subject = '$subject' && class='$class' && section='$section' && Id='11'";
$result=mysql_query($sql) or die ("query failed12");
if (mysql_num_rows ($result) == 1)
{		
echo "You have submitted $subject test questions for week $weeks. Click <a href='esubject.php'><b>here</a></b> to select another test.";
exit();
}
else
{
echo  "<hr/><div id='form-content'><form method='post' id='reg-form' align='center'>
         <input name='Id' type='hidden'  value='1' id='lname'/>          
               <p align='center'>
                   <button style='font-size: 10pt; font-family: arial; font-weight: bold; color: #ffffff; background-color : #0000ff; border-color: #bbbbff; width: 20'>START SETTING TEST QUESTIONS NOW...</button></form><hr/>"; ?>
