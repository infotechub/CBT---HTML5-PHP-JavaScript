...
if ($username=='')
{
echo "You can't access this page without logging in. Click <a href='index.php'>here</a> to login.";
exit();
}
else
{
...
<?php 
echo "<div id='form-content'><form method='post' id='reg-form' align='center'>
         <input name='Id' type='hidden'  value='1' id='lname'/>          
               <p align='center'>
                   <button style='font-size: 10pt; font-family: arial; font-weight: bold; color: #ffffff; background-color : #0000ff; border-color: #bbbbff; width: 20'>START TEST NOW...</button></form></div><hr/>"; ?>
