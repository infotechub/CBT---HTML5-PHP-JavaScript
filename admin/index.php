...
<section class="mbr-section" id="content1-4">
    <div class="mbr-section__container container mbr-section__container--middle">
        <div class="row">
            <div class="mbr-article mbr-article--wysiwyg col-sm-8 col-sm-offset-2"><h2 id="flyin" style="position:relative;left:-800px;font-style:italic" style=&{ns4def};><p align="center">If you have your pin code, kindly log in here</p>
              <form method='post' align='center' action="enter.php">
                <label>
                <div align="center">
    <input type='text' size='20' class='register-input' name='username'  placeholder='Enter Username Here' autocorrect='off' required></div></label><label>
                <div align="center">
    <input type='password' size='20' class='register-input' name='password'  placeholder='Enter Password Here' autocorrect='off' required></div></label>
                  <input type="submit" name="Submit"  style="font-size: 10pt; font-family: arial; font-weight: bold; color: #ffffff; background-color : #0000ff; border-color: #bbbbff; width: 20" value="Access Now"></h2>
                  <hr/> <p align='center'>You are advised to keep your pincode safe<br/>Click <a href="recover.php">here</a> to retrieve your pin code<hr/>
                </div>
                </label>
